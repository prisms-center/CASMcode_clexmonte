...
void ZrO_Clexulator_formation_energy::_calc_restricted_global_corr_contribution(
  ...
  // std::cout << "ZrO_Clexulator_formation_energy 0" << std::endl;
  _calc_restricted_global_corr_contribution(ind_list_begin, ind_list_end);
  // std::cout << "ZrO_Clexulator_formation_energy 1" << std::endl;
  for (; ind_list_begin < ind_list_end; ind_list_begin++) {
    // std::cout << "ZrO_Clexulator_formation_energy 2" << std::endl;
    *(corr_begin + *ind_list_begin) = ParamPack::Val<double>::get(
        m_params, m_corr_param_key, *ind_list_begin);
    // std::cout << "ZrO_Clexulator_formation_energy 3" << std::endl;
  }
  // std::cout << "ZrO_Clexulator_formation_energy 4" << std::endl;
}
...
void ZrO_Clexulator_formation_energy::_calc_restricted_global_corr_contribution(
  ...
  // std::cout << "ZrO_Clexulator_formation_energy 5" << std::endl;
  m_params.pre_eval();
  // std::cout << "ZrO_Clexulator_formation_energy 6" << std::endl;
  {
    // std::cout << "ZrO_Clexulator_formation_energy 7" << std::endl;
    _global_prepare<double>();
    // std::cout << "ZrO_Clexulator_formation_energy 8" << std::endl;
    for (; ind_list_begin < ind_list_end; ind_list_begin++) {
      // std::cout << "ZrO_Clexulator_formation_energy 9" << std::endl;
      ParamPack::Val<double>::set(
          m_params, m_corr_param_key, *ind_list_begin,
          (this->*m_orbit_func_table_0[*ind_list_begin])());
      // std::cout << "ZrO_Clexulator_formation_energy 10" << std::endl;
    }
    // std::cout << "ZrO_Clexulator_formation_energy 11" << std::endl;
  }
  // std::cout << "ZrO_Clexulator_formation_energy 12" << std::endl;
  m_params.post_eval();
  // std::cout << "ZrO_Clexulator_formation_energy 13" << std::endl;
}
