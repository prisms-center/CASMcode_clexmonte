...
ext_modules = [
    Pybind11Extension("libcasm.kmc._kmc", ["src/kmc.cpp"],
                      **ext_modules_params),
]
...
setup(
    ...
    version=__version__,
    url='https://github.com/prisms-center/CASMcode_clexmonte',
    description='CASM clexmonte library Python interface',
