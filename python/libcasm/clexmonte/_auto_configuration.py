...
def make_initial_state(
    ...
    1. Find a motif configuration:
       ...
       - Use the calculator's potential to find the motif configuration at the
         ...
         - If multiple candidate motifs have approximately the same minimum potential,
           ...
           - Equivalent configurations removed, as determined by having the same
    ...
    2. Find the initial state's supercell
       ...
       - A minimum supercell is constructed using:
       ...
       - The minimum supercell is scaled using :func:`scale_supercell`, subject to
...
def make_canonical_initial_state(
    ...
    2. Modify the configuration of the state generated by the previous step to
       enforce the composition provided by input `conditions` as closely as possible.
    ...
    3. Return the Monte Carlo state with configuration generated by the previous step
       ...
       composition to exactly match the composition of the configuration.
