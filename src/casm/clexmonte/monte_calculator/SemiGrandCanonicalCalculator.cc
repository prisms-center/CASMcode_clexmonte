#ifndef CASM_clexmonte_SemiGrandCanonicalCalculator
#define CASM_clexmonte_SemiGrandCanonicalCalculator
...
class SemiGrandCanonicalCalculator : public BaseMonteCalculator {
 public:
  ...
  void set_state_and_potential(state_type &state,
    ...
    validate_keys(conditions.scalar_values, {"temperature"} /*required*/,
