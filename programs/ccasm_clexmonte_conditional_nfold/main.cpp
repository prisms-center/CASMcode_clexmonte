...
#include "casm/clexmonte/conditional_nfold/conditional_nfold_json_io.hh"
#include "casm/clexmonte/run/io/json/parse_and_run_series.hh"

using namespace CASM;

// ///////////////////////////////////////
// ccasm-clexmonte-conditional-nfold main:
...
void print_help() {
  ...
  log.paragraph(
      "usage: ccasm-clexmonte-conditional-nfold [-h] [-V] system.json "
      "run_params.json");
  log << std::endl;

  log.paragraph(
      "ccasm-clexmonte-conditional-nfold is a program for conditionally "
      "running "
      "N-fold way or Metropolis semi-grand canonical Monte Carlo calculations "
      "using "
      "cluster expansions generated by CASM.");
  log << std::endl;
...
int main(int argc, char *argv[]) {
  ...
  using namespace CASM::clexmonte::conditional_nfold;
  try {
    parse_and_run_series<ConditionalNfold_mt19937_64>(system_json_file,
                                                      run_params_json_file);
