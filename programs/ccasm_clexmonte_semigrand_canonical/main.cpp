...
// ///////////////////////////////////////
// ccasm-clexmonte-semigrand-canonical main:
...
void print_help() {
  ...
  log.paragraph(
      "usage: ccasm-clexmonte-semigrand-canonical [-h] [-V] system.json "
      "run_params.json");
  log << std::endl;

  log.paragraph(
      "ccasm-clexmonte-semigrand-canonical is a program for running "
...
int main(int argc, char *argv[]) {
  ...
  using namespace CASM::clexmonte::semigrand_canonical;
  try {
